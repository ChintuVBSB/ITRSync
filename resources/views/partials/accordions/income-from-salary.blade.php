        ...
        <div x-show="open" x-collapse class="px-6 py-4 space-y-6 text-sm text-gray-700">
            ...
            <div class="space-y-2 mt-6">
                ...
                <div class="flex flex-row sm:grid-cols-5 gap-4">
                    <input type="text" wire:model="data.income.salary.employer_pan" placeholder="TAN or PAN of Employer" class="rounded border p-2" />
                    <input type="text" wire:model="data.income.salary.employer_address" placeholder="Address of Employer" class="rounded border p-2" />
                    <input type="number" wire:model="data.income.salary.salary_amount" placeholder="Salary Amount" class="rounded border p-2" />
                </div>
            </div>
            ...
            <div class="mt-6 space-y-2">
                ...
                <div class="flex flex-row gap-4">
                    <input type="number" wire:model="data.income.salary.hra_rent_paid" placeholder="Rent Paid" class="rounded border p-2" />
                    <input type="text" wire:model="data.income.salary.hra_city" placeholder="City of Residence" class="rounded border p-2" />
                </div>
                <div class="pl-4 border-l-4 border-indigo-300 mt-4">
                    ...
                    <div class="flex flex-row sm:grid-cols-4 gap-4">
                        <input type="text" wire:model="data.income.salary.hra_landlord_name" placeholder="Name of Landlord" class="rounded border p-2" />
                        <input type="text" wire:model="data.income.salary.hra_property_address" placeholder="Address of the Property" class="rounded border p-2 col-span-2" />
                    </div>
                </div>
            </div>
        </div>
